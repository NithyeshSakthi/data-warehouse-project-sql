-- ============================================================
-- BRONZE INGESTION: CUSTOMER INFORMATION (cust_info_raw)
-- Layer: Bronze
...
COPY INTO data_warehose.`1_bronze`.cust_info_raw  
FROM 's3://s3-databrick-warehouse/databases/source_crm/cust_info.csv'
FILEFORMAT = CSV
FORMAT_OPTIONS (
    'header' = 'true',
    'inferSchema' = 'true',
